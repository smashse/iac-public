# Private Instance for Atlantis
resource "aws_instance" "template_instance_atlantis" {
  ...
  private_ip                  = "10.0.10.80"
  source_dest_check           = true
  user_data                   = file("./cloud_init/cloud-init-atlantis.conf")
  ...
  tags = {
    Name = "template-instance-atlantis"
  }
}
