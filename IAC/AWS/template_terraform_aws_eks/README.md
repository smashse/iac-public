This is an example model for creating an EKS environment with the AWS provider on Terraform.

## Download the Terraform template

```bash
git clone https://github.com/smashse/iac-public.git
cd iac-public/IAC/AWS/template_terraform_aws_eks/
```

Or to download "README.md" and "template_terraform_aws_eks":
...
git checkout iac-public/master -- IAC/AWS/template_terraform_aws_eks
git checkout iac-public/master -- IAC/AWS/template_terraform_aws_eks/README.md
```

```bash
cd IAC/AWS/template_terraform_aws_eks/
```
...
**Notes:** This document has few modifications to the original document provided by Hashicorp in "Provision an EKS Cluster (AWS)"
...
cluster_endpoint = https://A1ADBDD0AE833267869C6ED0476D6B41.gr7.us-east-1.eks.amazonaws.com
...
clusters:
- cluster:
    server: https://A1ADBDD0AE833267869C6ED0476D6B41.gr7.us-east-1.eks.amazonaws.com
  ...
  name: eks_template-eks-TNajBRIF

contexts:
- context:
    cluster: eks_template-eks-TNajBRIF
    user: eks_template-eks-TNajBRIF
  name: eks_template-eks-TNajBRIF

current-context: eks_template-eks-TNajBRIF
